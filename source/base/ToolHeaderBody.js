/**
 * DBFORGE TOOL : Base/ToolHeaderBody
 * ======================================================================
 * Simple wrapper for the header, so we can trigger updates on it.
 * ----------------------------------------------------------------------
...
export default class ToolHeaderBody extends PureComponent {
    /**
